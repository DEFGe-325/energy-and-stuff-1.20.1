...
import net.defge.energyandstuff.screen.slot.CustomFuelSlot;
...
public class FuelGeneratorMenu extends AbstractContainerMenu {
    ...
    public FuelGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FUEL_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((FuelGeneratorBlockEntity) entity);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new CustomFuelSlot(iItemHandler, 0, 80, 54));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 26, 36));
        });
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.FUEL_GENERATOR.get());
    }
